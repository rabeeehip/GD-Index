...
const uiConfig = {
  ...
  "helpURL": "https://t.me/rabeehip", // Provide the URL of the help page(instructions for using the index). Leave this empty if you want to hide the help icon. Providing a URL will open the help page in a new tab. (You can use telegra.ph to write instructions)
  "footer_text": "© 2023 ‧ R-Service. All rights reserved ❤️", // Provide the footer text. Leave this empty if you want to hide it.
